...
- Incorporation of advanced branch prediction algorithms, such as perceptron or neural branch prediction
...
## References
- [1] John L. Hennessy and David A. Patterson. "Computer Architecture: A Quantitative Approach" (5th Edition). Morgan Kaufmann, 2011.
