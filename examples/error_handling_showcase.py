...
def demonstrate_instruction_parsing_errors():
    ...
    invalid_instructions = [
        {"code": "invalid_opcode $t0, $t1", "description": "Unknown instruction"},
        {"code": "add $t0, $invalid_reg", "description": "Invalid register name"},
        {"code": "lw $t0, invalid_offset($sp)", "description": "Invalid memory offset"},
        {
...
def demonstrate_pipeline_exceptions():
    ...
    pipeline_errors = [
        {
            "exception": PipelineStallError(
                "Structural hazard detected", "resource_conflict"
            ),
